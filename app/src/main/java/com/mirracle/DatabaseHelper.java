...
//All the local storage part of sqlite was happens here
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String KEY_REFERRED = "referred";
    ...
    public void addContact(User contact) {
        try {
            ...
            values.put(KEY_DEVICETYPE, contact.DeviceType);
            values.put(KEY_REFERRED, contact.RefferedBy);
    ...
    public List<User> getAllContacts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.DeviceType = cursor.getString(2);
                contact.RefferedBy = cursor.getString(3);
                contact.Email = cursor.getString(5);
